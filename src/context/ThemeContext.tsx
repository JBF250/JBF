...
export function ThemeProvider({ children, initialMode }: { children: ReactNode; initialMode?: ThemeMode }) {
  ...
  useEffect(() => {
    if (themeMode === 'dark') {
      ...
      document.documentElement.style.setProperty('--btn-primary', 'linear-gradient(135deg, #8ca2b5, #22d3ee)')
      document.documentElement.style.setProperty('--btn-primary-text', '#0c1620')
      document.documentElement.style.setProperty('--accent-pink', '#8ca2b5')
      document.documentElement.style.setProperty('--accent-cyan', '#22d3ee')
      document.documentElement.style.setProperty('--accent-purple', '#8ca2b5')
    } else {
